...
export default function VerifyEmail({ verificationUrl }: VerifyEmailProps) {
  ...
  return (
    <Html lang="en">
      ...
      <Preview>Verify your email address to get started with {PROJECT_NAME}</Preview>
        ...
        <Container style={styles.wrapper}>
          ...
          <Section style={styles.card}>
            ...
            <Section style={styles.content}>
              ...
              <Text style={styles.text}>You&apos;re almost there. Confirm your email address to finish creating your {PROJECT_NAME} account.</Text>
              ...
              <Section style={styles.notice}>
                <Text style={styles.noticeText}>For your security, this verification link will only be available for a limited time.</Text>
              </Section>
          ...
          <Section style={styles.footerSection}>
            <Text style={styles.footer}>If you didn&apos;t create a {PROJECT_NAME} account, you can safely ignore this email.</Text>
